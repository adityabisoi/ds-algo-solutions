...
public class EqualStacks {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int n1 = Integer.parseInt(n1N2N3[0].trim()); // number of cylinders in first stack 
        int n2 = Integer.parseInt(n1N2N3[1].trim()); // number of cylinders in Second stack
        int n3 = Integer.parseInt(n1N2N3[2].trim()); // number of cylinders in Third stack
 
        int[] h1 = new int[n1]; // height of cylinder in first stack
        ...
        int[] h2 = new int[n2]; // height of cylinder in Second stack
        ...
        int[] h3 = new int[n3]; // height of cylinder in Third stack
